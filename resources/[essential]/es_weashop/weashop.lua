	...
	menu = {
		...
		["Melee"] = {
			...
			buttons = {
				...
				{title = "Bat", name = "Bat", costs = 600, description = {}, model = "WEAPON_Bat"},
				{title = "Crowbar", name = "Crowbar", costs = 600, description = {}, model = "WEAPON_Crowbar"},
				{title = "Golfclub", name = "Golfclub", costs = 500, description = {}, model = "WEAPON_Golfclub"},
				...
				{title = "Hatchet", name = "Hatchet", costs = 900, description = {}, model = "WEAPON_Hatchet"},
				{title = "KnuckleDuster", name = "KnuckleDuster", costs = 400, description = {}, model = "WEAPON_KnuckleDuster"},
				{title = "Machete", name = "Machete", costs = 800, description = {}, model = "WEAPON_Machete"},
				{title = "Flashlight", name = "Flashlight", costs = 100, description = {}, model = "WEAPON_Flashlight"},
				{title = "SwitchBlade", name = "SwitchBlade", costs = 400, description = {}, model = "WEAPON_SwitchBlade"},
		...
		["Pistolets"] = {
			...
			name = "Pistolets",
			buttons = {
				{title = "Pistol", name = "Pistol", costs = 5000, description = {}, model = "WEAPON_Pistol"},
				--{title = "Combat Pistol", name = "CombatPistol", costs = 1000, description = {}, model = "WEAPON_CombatPistol"},
				{title = "Pistol Cal 50", name = "Pistol50", costs = 12000, description = {}, model = "WEAPON_PISTOL50"},
				{title = "SNS Pistol", name = "SNSPistol", costs = 2000, description = {}, model = "WEAPON_SNSPistol"},
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 10000, description = {}, model = "WEAPON_HeavyPistol"},
				...
				{title = "Revolver", name = "Revolver", costs = 11000, description = {}, model = "WEAPON_Revolver"},
				{title = "AP Pistol", name = "APPistol", costs = 23000, description = {}, model = "WEAPON_APPistol"},
		...
		["Shotguns"] = {
			...
			buttons = {
				...
				{title = "Sawn-off Shotgun", name = "SawnoffShotgun", costs = 28000, description = {}, model = "WEAPON_SawnoffShotgun"},
		...
		["ThrownWeapons"] = {
			...
			buttons = {
				...
				{title = "Ball", name = "Ball", costs = 500, description = {}, model = "WEAPON_Ball"},
...
local weashop_locations = {
 -- San Andreas { entering = {74.504,-1971.366,19.788}, inside = {70.529,-1975.843,50.837}, outside = {74.504,-1971.366,19.788} },
 { entering = {1692.35,3758.4,33.7053}, inside = {1692.35,3758.4,34.7053}, outside = {1692.35,3758.4,33.7053} },
 { entering = {252.705,-48.3091,68.941}, inside = {252.705,-48.3091,69.941}, outside = {252.705,-48.3091,68.941} },
 { entering = {844.225,-1033.52,27.1949}, inside = {844.225,-1033.52,28.1949}, outside = {844.225,-1033.52,27.1949} },
 { entering = {20.2025,-1106.48,28.797}, inside = {20.2025,-1106.48,29.797}, outside = {20.2025,-1106.48,28.797} },
 { entering = {-331.602,6082.43,30.4548}, inside = {-331.602,6082.43,31.4548}, outside = {-331.602,6082.43,30.4548} },
 { entering = {-664.085,-935.515,20.8292}, inside = {-664.085,-935.515,21.8292}, outside = {-664.085,-935.515,20.8292} },
 { entering = {-1305.39,-392.32,35.6958}, inside = {-1305.39,-392.32,36.6958}, outside = {-1305.39,-392.32,35.6958} },
 { entering = {-1119.14,2697.27,17.5542}, inside = {-1119.14,2697.27,18.5542}, outside = {-1119.14,2697.27,17.5542} },
 { entering = {2569.76,294.456,107.735}, inside = {2569.76,294.456,108.735}, outside = {2569.76,294.456,107.735} },
 { entering = {-3172.62,1085.99,19.8388}, inside = {-3172.62,1085.99,20.8388}, outside = {-3172.62,1085.99,19.8388} },
}
		...
		Citizen.CreateThread(function()
			while #weashop_blips > 0 do
				...
				for i,b in ipairs(weashop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and weashop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 10 then
