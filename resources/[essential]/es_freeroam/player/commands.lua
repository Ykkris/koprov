...
TriggerEvent('es:addCommand', 'help', function(source, args, user)
  TriggerClientEvent("chatMessage", source, "^3SYSTEM", {255, 255, 255}, "Commandes joueurs ")
	TriggerClientEvent("chatMessage", source, "^3SYSTEM", {255, 255, 255}, "-------------------------------------------------------")
	TriggerClientEvent("chatMessage", source, "^3SYSTEM", {255, 255, 255}, "/die permet de se suicider.")
	TriggerClientEvent("chatMessage", source, "^3SYSTEM", {255, 255, 255}, "/transfer pour transférer de l'argent.")
	TriggerClientEvent("chatMessage", source, "^3SYSTEM", {255, 255, 255}, "/givecash pour donner de la monnaie.")
end)
