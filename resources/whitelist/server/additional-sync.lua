...
AddEventHandler( "MSQonClientMapStart", function()
	...
	if ACL ~= nil then
		if ACL:isAdministrator( source ) then
			TriggerClientEvent( "chatMessage", source, "", {255,255,255}, "^3Vous êtes connecté en tant qu'administrateur." )
		elseif ACL:isModerator( source ) then
			TriggerClientEvent( "chatMessage", source, "", {255,255,255}, "^3Vous êtes connecté en tant que modérateur." )
		end
	end
end)
