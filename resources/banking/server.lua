...
TriggerEvent('es:addCommand', 'checkbalance', function(source, args, user)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    ...
    TriggerClientEvent("pNotify:SendNotification", -1, { text = "Tu as <b style='color:green'>" .. amount .. "$</b> sur ton compte", type = "info", timeout = 10000, layout = "centerLeft",})
...
AddEventHandler('bank:deposit', function(amount)
  TriggerEvent('es:getPlayerFromId', source, function(user)
        ...
        TriggerClientEvent("pNotify:SendNotification", -1, { text = "<b style='color:green'>" .. amount .. "$</b> ont été déposés sur ton compte", type = "info", timeout = 10000, layout = "centerLeft",})
        ...
        TriggerClientEvent("pNotify:SendNotification", -1, { text = "Tu n'as pas <b style='color:red'>".. amount .."$</b> sur toi", type = "warning", timeout = 10000, layout = "centerLeft",})
        CancelEvent()
      end
  end)
end)
...
AddEventHandler('bank:withdraw', function(amount)
  TriggerEvent('es:getPlayerFromId', source, function(user)
      ...
      if(tonumber(amount) <= tonumber(bankbalance)) then
        ...
        TriggerClientEvent("pNotify:SendNotification", -1, { text = "Tu as retiré <b style='color:green'>" .. amount .. "$</b> de ton compte", type = "info", timeout = 10000, layout = "centerLeft",})
        TriggerClientEvent("banking:updateBalance", source, new_balance)
...
AddEventHandler('bank:withdrawAmende', function(amount)
    ...
    TriggerClientEvent("pNotify:SendNotification", -1, { text = "Tu as payé(e) <b style='color:red'>".. amount .."$</b> d'amende !", type = "warning", timeout = 10000, layout = "centerLeft",})
		TriggerClientEvent("banking:updateBalance", source, new_balance)
		TriggerClientEvent("banking:removeBalance", source, amount)
		CancelEvent()
    end)
  ...
  TriggerEvent('es:getPlayerFromId', fromPlayer, function(user)
      ...
      if(tonumber(amount) <= tonumber(bankbalance)) then
        ...
        TriggerEvent('es:getPlayerFromId', toPlayer, function(user2)
            ...
            TriggerClientEvent("pNotify:SendNotification", -1, { text = "Tu as reçu <b style='color:green'>" .. amount .. "$</b> de".. fromPlayer, type = "info", timeout = 10000, layout = "centerLeft",})
