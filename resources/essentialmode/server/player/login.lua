...
function LoadUser(identifier, source, new)
	...
	--local group = groups[result[1].group] -- groups is a table we dont have currently so just get this directly
	Users[source] = Player(source, result[1].permission_level, result[1].money, result[1].dirty_money, result[1].identifier, result[1].group)
