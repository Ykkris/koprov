...
Citizen.CreateThread(function()
	...
	while true do
		...
		Citizen.Trace(tostring(GetDistanceBetweenCoords(vente_location[1],vente_location[2],vente_location[3],GetEntityCoords(LocalPed())) < 5))
		Citizen.Trace(tostring(IsPedInAnyVehicle(LocalPed(), true))
		if GetDistanceBetweenCoords(vente_location[1],vente_location[2],vente_location[3],GetEntityCoords(LocalPed())) < 5 and IsPedInAnyVehicle(LocalPed(), true) == true then
