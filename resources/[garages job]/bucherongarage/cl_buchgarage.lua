...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(-14.61, -2658.18, 6.00, GetEntityCoords(LocalPed())) < 2 then
...
Citizen.Wait(0)
	...
	Citizen.InvokeNative(0xAD738C3085FE7E11, Citizen.PointerValueIntInitialized(vehicle))
end)
